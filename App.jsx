...
const TitleScreen=({onStart})=>(
  <div style={{textAlign:"center",padding:"28px 20px 24px"}}>
    ...
    <div style={{marginBottom:14}}><Btn onClick={onStart} variant="primary" style={{fontSize:"1.3rem",padding:"12px 40px",width:"100%"}}>▶  BEGIN ADVENTURE</Btn></div>
              ...
              return(
                <div key={item.name} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 0",borderBottom:`1px solid ${T.border}`}}>
                  ...
                  <div>
                    ...
                    {(type==="map"||type==="talent")&&<span style={{color:T.dim,fontFamily:"'VT323',monospace",fontSize:"0.75rem"}}>Use in Village</span>}
                  </div>
                </div>
              );
            })}
